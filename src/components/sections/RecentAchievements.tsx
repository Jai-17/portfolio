...
const RecentAchievements = () => {
  return (
    <div>
      <CardSpotlight>
        <div className="flex flex-col text-center gap-3 md:flex-row md:text-left md:gap-0 justify-between items-center mb-2">
          <h1 className="font-medium text-xl text-neutral-200 relative z-20">
            Overall Winner at JPMC Code for Good&apos;25
          </h1>
          <p className="text-neutral-400 md:text-neutral-300 text-xl font-semibold relative z-20">Jun&apos;25</p>
        </div>
      ...
      <CardSpotlight>
        <div className="flex flex-col text-center gap-3 md:flex-row md:text-left md:gap-0 justify-between items-center mb-2">
          ...
          <p className="text-neutral-400 md:text-neutral-300 text-xl font-semibold relative z-20">Dec&apos;24</p>
        </div>
        <div className="text-neutral-400 text-center md:text-left text-lg relative z-20">
